...
- 因为已知目标文件为`jpg`文件，所以进一步缩小范围
	- `CTRL+F`进行查找，然后复制文件地址，打开即可得到图片  ![](06智能系统安全运维与实践/img-015.png) ![](06智能系统安全运维与实践/img-016.png)![](img-014.jpg)
...
![](06智能系统安全运维与实践/img-001.png)

3‍⃣**关闭虚拟机的网络连接**，避免恶意程序运行过程中与外部环境继续通信。
![](06智能系统安全运维与实践/img-002.png)
同时还需要断开
```txt
共享文件夹
共享粘贴板
...
![](06智能系统安全运维与实践/img-003.png)
- 病毒需要解压并输入密码`"iqiqiya"`
- 运行病毒后生成一个`0.vbs`脚本
![](06智能系统安全运维与实践/img-004.png)
- 病毒运行时间太久了，已经无法打开`powershell`
- 在`Process Monitor`中终止进程，试图打开火绒剑但是失败了
![](06智能系统安全运维与实践/img-005.png)
...
![](06智能系统安全运维与实践/img-006.png)
在过滤结果中可以找到`.vbs`文件的相关路径
![](06智能系统安全运维与实践/img-007.png)
进一步查看单条记录可以看到该文件的具体路径
![](06智能系统安全运维与实践/img-008.png)
2‍⃣接着增加过滤条件来查看程序自身的进程活动
![](06智能系统安全运维与实践/img-009.png)
![](06智能系统安全运维与实践/img-010.png)
...
![](06智能系统安全运维与实践/img-011.png)
- 清理完成后可以看到磁盘空间已恢复到接近实验前的状态，说明本次杀毒工作完成

---
# 游乐场
![](06智能系统安全运维与实践/img-017.png)

## 准备

- 先从畅课平台上将文件下载到本地、解压
![](06智能系统安全运维与实践/img-018.png)
...
```
配置如下图
![](06智能系统安全运维与实践/img-020.png)
![](06智能系统安全运维与实践/img-021.png)
...
![](06智能系统安全运维与实践/img-022.png)

保持Stapler 开机，再启动kali

![](06智能系统安全运维与实践/img-023.png)
